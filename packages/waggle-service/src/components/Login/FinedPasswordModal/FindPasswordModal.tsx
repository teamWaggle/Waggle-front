import { Flex, Heading, Text, Logo, Modal, Button } from "waggle-design-system";
...
import type { FindEmailModalProps } from "@/components/Login/FindEmailModal/FindEmailModal";
...
const FindPasswordModal = ({ isOpen, onClose, openLoginModal }: FindEmailModalProps) => {
  const {
    memberId,
    mode,
    emailRef,
